...
class CIOState(genpy.Message):
  _md5sum = "a7f214689509694603beffea47eac839"
  _type = "xarm_msgs/CIOState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# contorller gpio module state
int16 state
...
uint8[16] output_conf"""
  __slots__ = ['state','code','input_digitals','output_digitals','input_analogs','output_analogs','input_conf','output_conf']
  _slot_types = ['int16','int16','uint16[2]','uint16[2]','float32[2]','float32[2]','uint8[16]','uint8[16]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       state,code,input_digitals,output_digitals,input_analogs,output_analogs,input_conf,output_conf
